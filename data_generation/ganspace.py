...
def parse_args():
    ...
    parser.add_argument("--method", type=str, default="ganspace")
...
if __name__ == "__main__":
    ...
    print("Generating Dataset for GANSpace direction-finding method.")
    print("="*80)
    ...
    directions = direction_sampler.get_ganspace_directions(
        generator,
        w_codes,
        layer_range,
        device,
